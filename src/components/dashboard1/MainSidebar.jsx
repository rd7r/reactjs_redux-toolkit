let user = require('admin-lte/dist/img/user2-160x160.jpg');
let logo = require('admin-lte/dist/img/AdminLTELogo.png');
const MainSidebar = () => {
    return (
        <>
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <div class="sidebar">
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        <div class="image">
                            <img src={user} class="img-circle elevation-2" alt="UserImage" />
                        </div>
                        <div class="info">
