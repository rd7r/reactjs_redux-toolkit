                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="direct-chat-messages">
                                            ...
                                            <div className="direct-chat-msg">
                                                ...
                                                {/* <!-- /.direct-chat-infos --> */}
                                                <img className="direct-chat-img" src="dist/img/user1-128x128.jpg" alt="MessageUserImage"/>
                                                    {/* <!-- /.direct-chat-img --> */}
                                            ...
                                            <div className="direct-chat-msg right">
                                                ...
                                                {/* <!-- /.direct-chat-infos --> */}
                                                <img className="direct-chat-img" src="dist/img/user3-128x128.jpg" alt="MessageUserImage"/>
                                                    {/* <!-- /.direct-chat-img --> */}
                                                    <div className="direct-chat-text">
                            ...
                            <section className="col-lg-5 connectedSortable">
                                ...
                                <div className="card bg-gradient-info">
                                    ...
                                    <div className="card-footer bg-transparent">
                                        <div className="row">
                                            <div className="col-4 text-center">
                                                <input type="text" className="knob" data-readonly="true" defaultValue="20" data-width="60" data-height="60"
                                                    data-fgcolor="#39CCCC"/>
